class ClientFrog extends ClientMob {
    constructor(id, pos, width, height, scene, maxHealth, rarity) {
        super(id, scene, new HealthBar(scene, maxHealth, pos.x, pos.y, height * (-0.6), "MOB", "Dangerous Frog", rarity), pos);
